...
# huvudmapp
os.chdir('..')
project_path  = "/loggbok/Digital Loggbok/program/"
# undermapp
...
if _debug:
    ...
    log_online_path = '/loggbok/Digital Loggbok/log'
    mnt_loggbook_path = '/loggbok/Digital Loggbok/'
